      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_1fr]">
        <div className="space-y-6">
          ...
          <p className="text-sm leading-7 text-slate-300">
            {isArabic
              ? 'هل أنت مستعد للانتقال بعيداً عن العلامات التجارية وبدء تحقيق إيرادات حقيقية؟ دعنا نخطط استراتيجية تناسب أهداف نموك.'
        ...
        <div className="rounded-[1.8rem] border border-cyan-300/30 bg-gradient-to-br from-cyan-400/10 to-transparent p-8 flex flex-col justify-between">
          <div>
            ...
            <p className="text-sm text-slate-300 mb-6">
              {isArabic
                ? 'وكالة النمو والاستراتيجية - حيث تلتقي الإبداع بالنتائج.'
